...
useEffect(() => {
 ...
 <span
  ref={wordLeftRef}
  className="font-[ProcerusRegular] text-green-400 leading-[0.8] tracking-[0.005em] transform scale-y-[1.12]
             text-[34vh] sm:text-[36vh] md:text-[38vh] z-[120] pointer-events-none"
  style={{
